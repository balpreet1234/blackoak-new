...
<head>
  ...
  <link rel="icon" href="{{ asset('public/admin_assets/images/favicon-32x32.png') }}" type="image/png" />
  <!--plugins-->
  ...
  <link href="{{ asset('public/admin_assets/css/light-theme.css') }}" rel="stylesheet" />
...
<body>
  ...
  <script src="{{ asset('public/admin_assets/plugins/apexcharts-bundle/js/apexcharts.min.js') }}"></script>
  <!--app-->
  <script src="{{ asset('public/admin_assets/js/app.js') }}"></script>
  <script src="{{ asset('public/admin_assets/js/index5.js') }}"></script>
